...
class EducationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post educations_url, params: { education: { course: @education.course, description: @education.description, time: @education.time, university: @education.university } }
    end
  ...
  test "should update education" do
    patch education_url(@education), params: { education: { course: @education.course, description: @education.description, time: @education.time, university: @education.university } }
